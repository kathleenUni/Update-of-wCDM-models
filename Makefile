...
CCFLAG = -g -fPIC -gdwarf-2 -gstrict-dwarf -std=gnu99 
LDFLAG = -g -fPIC  
...
TOOLS = cisi.o growTable.o dei_rkck.o sparse.o evolver_rkck.o  evolver_ndf15.o arrays.o parser.o quadrature.o hyperspherical.o common.o trigonometric_integrals.o
